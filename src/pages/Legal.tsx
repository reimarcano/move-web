...
export function LegalNotice() {
  return (
    <LegalLayout eyebrow="Información legal" title="Aviso legal">
      ...
      <Section title="Enlaces externos"><p className="mb-0">La web puede incluir enlaces a sitios de terceros, como WhatsApp, Google Maps, la plataforma de reservas o redes sociales. MOVE Pilates Boutique no controla sus políticas ni sus contenidos; consulta sus condiciones y políticas de privacidad antes de utilizarlos.</p></Section>
...
export function PrivacyPolicy() {
  return (
    <LegalLayout eyebrow="Protección de datos" title="Política de privacidad">
      ...
      <Section title="Finalidades y base jurídica"><ul className="space-y-2 pl-5 text-[15px] leading-[1.75] text-[#493523]"><li>Atender consultas, solicitudes de información y peticiones de reserva: aplicación de medidas precontractuales solicitadas por la persona interesada.</li><li>Medir de forma agregada el uso de la web con Google Analytics: consentimiento.</li><li>Mostrar el mapa integrado de Google: consentimiento.</li></ul></Section>
